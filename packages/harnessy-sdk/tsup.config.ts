...
const executorSourceAliases = {
	...
	"@executor-js/plugin-graphql": executorSource("packages/plugins/graphql/src/sdk/index.ts"),
	"@executor-js/plugin-provider-service-split": executorSource("packages/plugins/provider-service-split/src/index.ts"),
	"@executor-js/plugin-openapi/providers/google": executorSource("packages/plugins/openapi/src/providers/google/index.ts"),
