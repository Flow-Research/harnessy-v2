...
**Examples:** [status-line.ts](../examples/extensions/status-line.ts), [built-in plan mode](../src/core/extensions/builtin/plan-mode.ts), [preset.ts](../examples/extensions/preset.ts)
...
**Examples:** [built-in plan mode](../src/core/extensions/builtin/plan-mode.ts)
...
- **Status indicators**: [built-in plan mode](../src/core/extensions/builtin/plan-mode.ts) - `setStatus` and `setWidget`
